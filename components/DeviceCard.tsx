                    ...
                    {!!valueText && (
                        <div className="flex-grow h-full min-w-0">
                             <AutoFitText
                                ...
                                dataAttrs={{ 'data-style-key': 'valueTextColor', 'data-style-name': 'Значение', 'data-is-text': 'true', 'data-style-origin': 'scheme', 'data-is-on': String(isOn) }}
                            />
                        </div>
                    )}
                </div>
