      ...
      LOCAL_STORAGE_KEYS.forEach(key => {
        ...
        if (item) {
          try {
            ...
            // Some items like theme are not JSON, store as is
            settings[key] = item;
          }
        }
      });
    ...
    return (
        ...
        <div className="w-full max-w-md bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg ring-1 ring-black/5 dark:ring-white/10 space-y-8">
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                ...
                <div>
                    <label htmlFor="owmKey" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  <button onClick={handleExportSettings} className="flex-1 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-white font-bold py-2 px-4 rounded-lg transition-colors duration-200">
                    Экспорт
                  </button>
         ...
         <ConfirmDialog
            ...
            message={
                <>
                    Вы уверены, что хотите удалить шаблон <strong className="text-black dark:text-white">"{deletingTemplate?.name}"</strong>?
                    <br />
