...
const futuristicTheme: ThemeObject = {
  "colorScheme": {
    "light": {
      ...
      "nameTextColor": "#2f4f4f", "statusTextColor": "#5c677d", "valueTextColor": "#007a7a", "unitTextColor": "#007a7a", "nameTextColorOn": "#007a7a", "statusTextColorOn": "#2f4f4f", "valueTextColorOn": "#0