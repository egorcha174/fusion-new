...
// FIX: Added dashboardBackgroundColor1 as it is a required property for ColorThemeSet.
      "dashboardBackgroundType": "image", "dashboardBackgroundColor1": "#0a0a19", "dashboardBackgroundImage": "data:image/jpeg;base64,-," ,"dashboardBackgroundImageBlur": 2, "dashboardBackgroundImageBrightness": 70, "cardOpacity": 0.75, "panelOpacity": 0.7,
...
const Settings: React.FC<{
    ...
    const handleExportSettings = () => {
        try {
            const allSettings = useAppStore.getState();
            const settingsToExport = {
                tabs: allSettings.tabs,
                activeTabId: allSettings.activeTabId,
                customizations: allSettings.customizations,
                templates: allSettings.templates,
                clockSettings: allSettings.clockSettings,
                cameraSettings: allSettings.cameraSettings,
                sidebarWidth: allSettings.sidebarWidth,
                isSidebarVisible: allSettings.isSidebarVisible,
                theme: allSettings.theme,
                scheduleStartTime: allSettings.scheduleStartTime,
                scheduleEndTime: allSettings.scheduleEndTime,
                colorScheme: allSettings.colorScheme,
                weatherProvider: allSettings.weatherProvider,
                openWeatherMapKey: allSettings.openWeatherMapKey,
                yandexWeatherKey: allSettings.yandexWeatherKey,
                forecaApiKey: allSettings.forecaApiKey,
                lowBatteryThreshold: allSettings.lowBatteryThreshold,
            };
    ...
    const handleImportSettings = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        reader.onload = (e) => {
            try {
                ...
                if (!window.confirm("Вы уверены? Это перезапишет все текущие настройки.")) return;
                
                const {
                    setTabs, setActiveTabId, setCustomizations, setTemplates, setClockSettings,
                    setCameraSettings, setSidebarWidth, setIsSidebarVisible, setTheme,
                    setScheduleStartTime, setScheduleEndTime, setColorScheme, setWeatherProvider,
                    setOpenWeatherMapKey, setYandexWeatherKey, setForecaApiKey, setLowBatteryThreshold
                } = useAppStore.getState();

                if(settings.tabs) setTabs(settings.tabs);
                if(settings.activeTabId) setActiveTabId(settings.activeTabId);
                if(settings.customizations) setCustomizations(settings.customizations);
                if(settings.templates) setTemplates(settings.templates);
                if(settings.clockSettings) setClockSettings(settings.clockSettings);
                if(settings.cameraSettings) setCameraSettings(settings.cameraSettings);
                if(settings.sidebarWidth) setSidebarWidth(settings.sidebarWidth);
                if(settings.isSidebarVisible !== undefined) setIsSidebarVisible(settings.isSidebarVisible);
                if(settings.theme) setTheme(settings.theme);
                if(settings.scheduleStartTime) setScheduleStartTime(settings.scheduleStartTime);
                if(settings.scheduleEndTime) setScheduleEndTime(settings.scheduleEndTime);
                if(settings.colorScheme) setColorScheme(settings.colorScheme);
                if(settings.weatherProvider) setWeatherProvider(settings.weatherProvider);
                if(settings.openWeatherMapKey) setOpenWeatherMapKey(settings.openWeatherMapKey);
                if(settings.yandexWeatherKey) setYandexWeatherKey(settings.yandexWeatherKey);
                if(settings.forecaApiKey) setForecaApiKey(settings.forecaApiKey);
                if(settings.lowBatteryThreshold) setLowBatteryThreshold(settings.lowBatteryThreshold);
                
                alert("Настройки импортированы.");
            } catch (err) { alert("Не удалось импортировать настройки. Неверный формат файла."); }
        };
                            ...
                            <div className="bg-gray-100 dark:bg-gray-700/50 p-4 rounded-lg space-y-3">
                                ...
                                <div className="flex gap-1 bg-gray-200 dark:bg-gray-900/50 p-1 rounded-lg">
                                    {[
                                        ...
                                        { val: 'auto', name: 'Авто' },
                                        { val: 'schedule', name: 'По расписанию' }
                                    ].map(({ val, name }) => (
                                        <button
                                            key={val}
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400">
                                    {{
                                        ...
                                        schedule: 'Тема будет автоматически переключаться на тёмную в указанный промежуток времени.'
                                    }[theme]}
                                </p>
                                {theme === 'schedule' && (
                                    <div className="pt-3 border-t border-gray-300 dark:border-gray-600/50 space-y-2">
                                        <div className="flex items-center justify-between">
                                            <label className="text-sm text-gray-800 dark:text-gray-300">Начало тёмной темы</label>
                                            <input
                                                type="time"
                                                value={scheduleStartTime}
                                                onChange={e => setScheduleStartTime(e.target.value)}
                                                className="bg-gray-200 dark:bg-gray-800/50 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-gray-600 rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
                                            />
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <label className="text-sm text-gray-800 dark:text-gray-300">Конец тёмной темы</label>
                                            <input
                                                type="time"
