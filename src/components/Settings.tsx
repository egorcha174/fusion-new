...
import { CardTemplate, DeviceType, ServerConfig, ThemeDefinition, Device, AuroraSettings } from '../types';
...
import { Section, LabeledInput } from './settings/SettingControls';
...
const Settings: React.FC<SettingsProps> = ({ onConnect, connectionStatus, error, variant = 'page', isOpen = false, onClose }) => {
    ...
    const {
        templates, handleDeleteTemplate, setEditingTemplate,
